* 云 IP：
  123.57.50.82    2017-01 - 2017-08
  59.110.235.115  2017-08 - 2019-08
...
* 网络
  123.57.50.82 是经典网络, 只需要设置好iptbles 就可以了。
  59.110.235.115 是专有网络, 需要在阿里云控制台设置, 云服务器ECS -> 网络和安全 -> 安全组 -> 配置规则 修改, telnet 59.110.235.115 80 可以验证.
  80, 3306, 3838, 3001, 8080, 8983, 27017端口需要设置.  注意如果是用127.0.0.1的话，就不需要设置，不走网卡
...
* mongodb 数据迁移.
  ...
  mongodump --host 127.0.0.1:27017 -d poetry -u poetry -p poetry123 -o /home/leslie/MyProject/Python/Backup/170813: 带用户、数据库
  ...
  mongorestore --host 127.0.0.1:27017 -d poetry -u poetry -p poetry123 /home/leslie/MyProject/data/mongodb/170813/poetry
